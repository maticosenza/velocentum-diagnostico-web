    ...
    escenarios90d: [
      {
        ...
        visible: true,
        confianza: "media",
        contribucionAcumulada90d: valorRetenido("La rentabilidad está pendiente."),
      ...
      },
      {
        ...
        visible: true,
        confianza: "media",
        contribucionAcumulada90d: metric(5_000_000),
    ...
    escenarios90d: [
      {
        ...
        visible: true,
        confianza: "alta",
        contribucionAcumulada90d: metric(0),
        ritmoMensualDia90: metric(0),
        palancas: [{ id: "retencion", nombre: "Retención", contribucion: metric(0) }],
        mensual: [],
        supuestos: [],
        restriccionesAplicadas: [],
      },
      {
        ...
        visible: true,
        confianza: "alta",
        contribucionAcumulada90d: metric(3_000_000),
        ritmoMensualDia90: metric(1_200_000),
        palancas: [{ id: "captacion", nombre: "Captación", contribucion: metric(3_000_000) }],
        mensual: [],
        supuestos: [],
        restriccionesAplicadas: [],
      },

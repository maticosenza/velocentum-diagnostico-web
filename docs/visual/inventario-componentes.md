...
| `roadmap` | `shared.ts:roadmapSection` (169-177) | `case "roadmap"` (664-680) | `RoadmapBlock` (404-423) | proyeccion-90d, propuesta | `context.roadmap[]` — **siempre vacío hoy**: `build-context.ts` fija `roadmap: []` incondicional, así que este bloque nunca produce contenido en ningún documento generado desde el motor real |
